...
RUN mkdir -p ${DATADIR}
RUN wget http://storage.googleapis.com/gcd/tools/gcd-v1beta2-rev1-4.0.0.zip
RUN unzip gcd-v1beta2-rev1-4.0.0.zip && rm gcd-v1beta2-rev1-4.0.0.zip
WORKDIR gcd-v1beta2-rev1-4.0.0
